Contributing to DAPScoin Core
============================

The DAPScoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DAPScoin Core project, and is not to be
confused with overall DAPScoin Network Protocol consensus changes.

Whether a pull request is merged into DAPScoin Core rests with the project merge
...
Patches that change DAPScoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DAPScoin consensus, it must have been
...
The project leader is the release manager for each DAPScoin Core release.
