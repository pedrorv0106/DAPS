                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDAPSPathCustom = GetArg("-zdapsbackuppath", "");
    ...
    if(!strzDAPSPathCustom.empty()) {
        ui->wallet_customzdapsbackuppath->setText(QString::fromStdString(strzDAPSPathCustom));
        ui->wallet_customzdapsbackuppath_label->setVisible(true);
        ui->wallet_customzdapsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDAPSPathCustom.empty()) && nCustomBackupThreshold > 0) {
