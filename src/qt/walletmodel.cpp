...
static void NotifyzDAPSReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzDAPSReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzDAPSReset.connect(boost::bind(NotifyzDAPSReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzDAPSReset.disconnect(boost::bind(NotifyzDAPSReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zdapsTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus);
}
