...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("seed.theiexplorers.com", "seed.theiexplorers.com"));        // Single node address
        vSeeds.push_back(CDNSSeedData("seed1.theiexplorers.com", "seed1.theiexplorers.com"));        // Single node address
        vSeeds.push_back(CDNSSeedData("seed2.theiexplorers.com", "seed2.theiexplorers.com"));        // Single node address
        vSeeds.push_back(CDNSSeedData("seed3.theiexplorers.com", "seed3.theiexplorers.com"));        // Single node address
        vSeeds.push_back(CDNSSeedData("seed4.theiexplorers.com", "seed4.theiexplorers.com"));        // Single node address
        vSeeds.push_back(CDNSSeedData("seed5.theiexplorers.com", "seed5.theiexplorers.com"));        // Single node address
