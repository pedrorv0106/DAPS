...
// Copyright (c) 2018-2019 The DAPScoin Core developers
 ...
 * DAPScoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int nLastPOWBlock;
    int TEAM_REWARD_FREQUENCY = 24; //every  TEAM_REWARD_FREQUENCY PoA blocks, reward the daps team
    double MAX_MONEY;
