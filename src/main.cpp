...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        if (nTime >= 1572220800) { //Monday, Oct 28 at midnight UTC - 1572220800
        ...
        if (nTime >= 1572307200) { //Tuesday, Oct 29 at midnight UTC - 1572307200
        ...
        if (nTime >= 1572393600) { //Wed, Oct 30 at midnight UTC - 1572393600
        ...
        if (nTime >= 1572480000) { //Thursday, Oct 31 at midnight UTC - 1572480000
