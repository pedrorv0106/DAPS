...
extern UniValue setzdapsseed(const UniValue& params, bool fHelp);
extern UniValue getzdapsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdaps(const UniValue& params, bool fHelp);
extern UniValue dzdapsstate(const UniValue& params, bool fHelp);
