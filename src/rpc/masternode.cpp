...
UniValue masternodeconnect(const UniValue& params, bool fHelp)
{
    if (fHelp || (params.size() != 1))
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("masternodeconnect", "\"192.168.0.6:52572\"") + HelpExampleRpc("masternodeconnect", "\"192.168.0.6:52572\""));
...
UniValue getseesawrewardratio (const Array& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
