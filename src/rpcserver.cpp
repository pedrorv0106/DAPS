...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"wallet", "sendtostealthaddress", &sendtostealthaddress, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dapscoind, or the -server option to dapscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
