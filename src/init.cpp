...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the DAPS and zDAPS money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all DAPScoin specific functionality (Masternodes, Zerocoin, SwiftX, Budgeting) (0-1, default: %u)"), 0));
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i The DAPScoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
...
/** Sanity checks
 *  Ensure that DAPScoin is running in a usable environment with all
...
#endif
    // Make sure only a single DAPScoin process is using the data directory.
...
//    if (nAnonymizeDapscoinAmount < 2) nAnonymizeDapscoinAmount = 2;
    ...
    LogPrintf("Anonymize DAPScoin Amount %d\n", nAnonymizeDapscoinAmount);
